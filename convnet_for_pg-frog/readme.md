...
- In order to generate the PG-FROG traces (training images) by the numerical simulation, you should specify the temporal width of the laser pulse and chirp parameter. The temporal width of the laser pulse is determined by the duration when the laser pulse has significant intensity. The chirp parameter specifies the temporal dependence of the frequency of the light. The oscillating field of light in the graphical summary shows slow oscillation followed by fast oscillation 
